						  ...
						  $.map($scope.emails.arr, function(obj) {
							if(obj.id == target_id) {
							  ...
							  if (!obj.html) {
								...
								$('.message-body').css('padding', '10px 10px');
								$('.message-body').html("<iframe height='100%' width='100%' style='overflow-y:scroll;height:100%;width:100%' src='/get_email?id=" + obj.id + "' ></iframe>");
							  }
